            ...
            <div class="col-md-6">
                ...
                <form action="{{ route('save') }}" method="post" name="myForm" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-lg" id="inputAddress" name="address" placeholder="Укажите улицу и номер дома">
                    </div>

                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="inputPhone" class="col-form-label col-form-label-lg">Мобильный телефон</label>
                            <input type="text" class="form-control form-control-lg" id="inputPhone" name="phone" placeholder="+7 (000) 000-00-00">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="inputEmail" class="col-form-label col-form-label-lg">Электронная почта</label>
                            <input type="email" class="form-control form-control-lg" id="inputEmail" name="email" placeholder="Электронная почта">
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="form-group">
                        ...
                        <select id="inputSupervision" class="form-control form-control-lg" name="supervision">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-lg" id="inputCaseNumber" name="caseNumber" placeholder="12345678">
                    </div>

                    <div class="form-group">
                        <label for="inputAuthority" class="col-form-label col-form-label-lg">Орган в производстве, которого находятся материалы</label>
                        <input type="text" class="form-control form-control-lg" id="inputAuthority" name="authority" placeholder="МВД РК">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control form-control-lg" id="inputAgree" name="agree" rows="5"
                                  placeholder="Прекращением уголовного дела в отношении Иванова И."></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control form-control-lg" id="inputAction" name="action" rows="5"
                                  placeholder="Прошу отменить принятое решение и направить дело в суд"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control form-control-lg" id="inputSolve" name="solve" rows="5"></textarea>
                    </div>
                    {{--<div class="form-group">
